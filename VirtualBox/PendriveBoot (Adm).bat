...
echo [] Este script precisa ser executado como administrador no mesmo disco do VirtualBox,
echo    geralmente disco C:\.
...
set /p DISKNUM=">> Digite o numero do disco removivel:"
set /p LOCALDISK=">> Salvar VirtualDiskUsb em:"
set VMPATH=%LOCALDISK%\VirtualDiskUsb.vmdk

echo Criando VMDK apontando para PhysicalDrive%DISKNUM%...

REM Diretorio do VirtualBox
